        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
					...
					Alert TweetMeme whenever a new post is published, so it can update the details, such as the post title.
                </td>
            </tr>
            <tr>
                <th scope="row">
                ...
                <td>
                    <p>
						...
						<span class="setting-description">Your TweetMeme API Application ID, available from <a href="http://my.tweetmeme.com/profile" target="_blank">My TweetMeme</a>. Only applicable to users with Analytics accounts.</span>
                    </p>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <p>
						...
						<span class="setting-description">Your TweetMeme API Application Key, available from <a href="http://my.tweetmeme.com/profile" target="_blank">My TweetMeme</a>. Only applicable to users with Analytics accounts.</span>
                    </p>
                </td>
            </tr>
        </table>
