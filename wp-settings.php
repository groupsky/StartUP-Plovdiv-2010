...
if ( version_compare( '4.3', phpversion(), '>' ) ) {
	die( sprintf( /*WP_I18N_OLD_PHP*/'Версията ви на PHP е %s, но WordPress се нуждае от поне 4.3.'/*/WP_I18N_OLD_PHP*/, phpversion() ) );
}
...
if ( !extension_loaded('mysql') && !file_exists(WP_CONTENT_DIR . '/db.php') )
	die( /*WP_I18N_OLD_MYSQL*/'Изглежда, че вашата PHP конфигурация не включва поддръжка  за MySQL, без която WordPress не е в състояние да работи.'/*/WP_I18N_OLD_MYSQL*/ );
...
if ( is_wp_error($prefix) )
	wp_die(/*WP_I18N_BAD_PREFIX*/'<strong>Грешка</strong>: <code>$table_prefix</code> във <code>wp-config.php</code> може да съдържа само латински букви, цифри и долна черта.'/*/WP_I18N_BAD_PREFIX*/);
